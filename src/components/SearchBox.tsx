...
import { searchKeyWord, searchState } from '../state'

export default function SearchBox() {
    useSnapshot(searchKeyWord)
    // console.log(searchKeyWord.value)
    return (
        <div className={`flex items-center p-6 w-full h-20 focus-within:ring-2 ${searchState.value === "Error"? "ring-pink-400":"ring-purple-700"} rounded-xl`}>
